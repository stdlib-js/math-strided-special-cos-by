...
```javascript
cosBy = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-strided-special-cos-by@v0.1.0-umd/browser.js' )
```
...
[@stdlib/math/base/special/cos]: https://github.com/stdlib-js/stdlib/tree/umd
